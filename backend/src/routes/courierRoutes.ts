...
import { applyCourierSchema } from "../types/schemas";
...
router.post("/apply", handshakeMiddleware, validateBody(applyCourierSchema), (req, res) => courierController.apply(req, res));
